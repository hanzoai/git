...
* ENHANCEMENTS
  ...
  * Set setting.AppURL as GIT_ROOT_URL environment variable during pushes (#12752)
...
* ENHANCEMENTS
  ...
  * Support for custom GIT_CUSTOM env var in docker(#6608)
